...
describe('parseJSON', function() {
  it('should match the result of calling JSON.parse', function() {
    parseableStrings.forEach(function(test) {
      ...
      // Replace this line with an `expect` statement that tests the behavior described by the `it` string
  ...
  it('should throw an error for invalid stringified JSON', function() {
    unparseableStrings.forEach(function(test) {
      ...
      // if you'd prefer, you can write your version of parseJSON so that it passes this test instead of the one on line 21.
